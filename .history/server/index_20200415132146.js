...
app.use('/api/attribute', require(__dirname + '/modules/attribute'))
app.use('/api/consignee', require(__dirname + '/modules/consignee'))
app.use('/api/express', require(__dirname + '/modules/express'))
app.use('/api/category', require(__dirname + '/modules/category'))
app.use('/api/manager', require(__dirname + '/modules/manager'))
app.use('/api/permission', require(__dirname + '/modules/permission'))
app.use('/api/report', require(__dirname + '/modules/report'))
app.use('/api/role', require(__dirname + '/modules/role'))
app.use('/api/type', require(__dirname + '/modules/type'))
