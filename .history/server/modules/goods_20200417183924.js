...
router.get('/goods', async (req, res) => {
  ...
  let sql = "select goods_id,goods_name,goods_prices,goods_number,goods_weight,goods_status,add_time,upd_time,hot_mumber,is_promote from sp_goods limit " + (pagenum - 1) * pagesize + "," + pagesize
